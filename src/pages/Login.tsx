  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[85vh] px-4 py-12 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <div className="flex flex-col -space-y-1">
            <h1 className="text-4xl font-black text-slate-950 italic tracking-tighter uppercase leading-none">Shop Now</h1>
            <span className="text-[10px] font-black uppercase tracking-[0.4em] text-indigo-500">Đăng Nhập Tài Khoản</span>
          </div>
          <p className="text-slate-400 font-extrabold text-[10px] uppercase tracking-[0.2em] leading-relaxed mt-6 italic opacity-80 decoration-indigo-500">
            Đăng nhập để trải nghiệm mua sắm thông minh
          </p>
        </div>
        ...
        <div className="mt-12 pt-10 border-t border-slate-50 space-y-6">
          <div className="flex items-center gap-4 text-slate-200">
            <div className="h-[2px] flex-1 bg-slate-100"></div>
              <span className="text-[9px] font-black uppercase tracking-[0.4em] text-slate-300 italic">Mua sắm thông minh</span>
              <div className="h-[2px] flex-1 bg-slate-100"></div>
           </div>
           <div className="flex flex-col gap-2">
              <p className="text-[10px] font-bold text-slate-400 leading-relaxed text-center opacity-40 uppercase tracking-widest px-4">
                Tham gia để mua sắm và nhận hoa hồng.
              </p>
      ...
      <div className="absolute bottom-8 text-center opacity-30">
         <p className="text-[10px] font-black uppercase tracking-[0.5em] text-slate-300 italic">Hệ sinh thái An toàn</p>
      </div>
    </div>
  );
}
